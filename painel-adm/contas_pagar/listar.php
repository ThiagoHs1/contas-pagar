...
echo <<<HTML
<table id="example2" class="table table-hover table-white my-4">
<thead>
<tr>
<th>Descrição</th>
<th>Saída</th>		
...
echo <<<HTML
	...
	<td>
	<a href="#" onclick="editar('{$id}', '{$cp1}',  '{$cp3}', '{$cp4}', '{$cp5}', '{$cp6}', '{$cp7}', '{$cp8}', '{$cp9}', )" title="Editar Registro">	<i class="bi bi-pencil-square text-primary {$ocutar}"></i> </a>
	<a href="#" onclick="excluir('{$id}' , '{$cp1}')" title="Excluir Registro">	<i class="bi bi-trash text-danger {$ocutar}"></i> </a>

	<a class="mx-1" href="#" onclick="mostrarDados('{$id}', '{$cp1}',  '{$cp3}', '{$cp4}', '{$cp5}', '{$data_emissao}', '{$data_venc}', '{$cp8}', '{$valor}', '{$nome_usu_lanc}', '{$nome_usu_baixa}', '{$cp13}', '$cp18')" title="Ver Dados da Conta">
...
function editar(id, cp1,  cp3, cp4, cp5, cp6, cp7, cp8, cp9, nome){
