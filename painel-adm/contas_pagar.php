...
if($dias_frequencia == 30 || $dias_frequencia == 31){
	...
	if($dias_frequencia > 0){
		if($dia_recor == $dia){
			...
			$pdo->query("INSERT INTO $pagina set descricao =  '$cp1', saida = '$cp3', documento = '$cp4', plano_conta = '$cp5', data_emissao = curDate(), vencimento = '$nova_data_vencimento', frequencia = '$cp8', valor = '$cp9', usuario_lanc = '$cp10', status = 'Pendente', data_recor = '$data_recor'");
